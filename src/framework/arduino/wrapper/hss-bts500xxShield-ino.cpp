...
Bts500xxShield(hss1 = new HssIno(BTS500XX_HWCONFIG.den1_den3, BTS500XX_HWCONFIG.in1, BTS500XX_HWCONFIG.is1_is2, variantSel)
{
...
Bts500xxShieldIno::Bts500xxShieldIno(BtsVariants_t *variantSel, BTS500xxHwConfig_t config)):
 Bts500xxShield(hss1 = new HssIno(config.den1_den3, config.in1, config.is1_is2, variantSel)
{
